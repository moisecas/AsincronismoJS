...
const fetchData = (url_api) => {
  return new Promise((resolve, reject) => { //dos elementos 
    // instanciamos la conexion
    const xhttp = new XMLHttpRequest(); //una constante de 
    // abrir una conexion con el metodo, la ruta y si es asincrono
    xhttp.open('GET', url_api, true);
    // validacion del llamado
    xhttp.onreadystatechange = (() => { //estructura para mandar el arrow function 
...
// exportamos o invocamos la funcion
module.exports = fetchData; //exportar 